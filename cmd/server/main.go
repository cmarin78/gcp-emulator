...
import (
	...
	"github.com/cesar/gcp-emulator/internal/services/assetinventory"
...
func main() {
	...
	cloudrun.New(db, realGovernor).Register(mux)
	cloudfunctions.New(db, realGovernor).Register(mux)
	...
	assetinventory.New(db).Register(mux)
